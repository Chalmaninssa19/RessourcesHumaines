    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="d-flex align-items-center d-navbar-brand brand-logo" style="text-decoration: none; color: #da8cff;" href="./index.html">
                    <i class="mdi mdi-account-box" style="font-size: 35px;margin-right: 25px;"></i> <h2 style="margin: 0;">GRH</h2>
                </a>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="submit" class="btn btn-gradient-primary me-1">Choisir le
                                        profil</button>
                                    <form class="forms-sample mt-3">
                                            ...
                                            <div class="list-wrapper">
                                                <table class="table">
                                                    <tr>
                                                        ...
                                                        <td><i class="list-action primary mdi mdi-comment-question-outline"></i></td>
                                                        <td><i class="list-action danger mdi mdi-close-circle-outline"></i></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <button type="submit" class="btn btn-gradient-primary me-2">Envoye du besoin</button>
                                    </form>
                                </div>
                            </div>
                        </div>
